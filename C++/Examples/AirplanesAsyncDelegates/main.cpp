...
int main() {
  ...
  try {
    ...
    do {
      ...
      if (queryJoinDelegate->errorInfo) {
        std::cout << queryJoinDelegate->errorInfo << std::endl;
        throw std::invalid_argument("first planes query join");
      }
      ...
      if (queryJoinDelegate->errorInfo) {
        std::cout << queryJoinDelegate->errorInfo << std::endl;
        throw std::invalid_argument("second planes query join");
      }
