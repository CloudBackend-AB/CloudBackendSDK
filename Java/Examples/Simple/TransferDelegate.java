...
public class TransferDelegate extends TransferEventProtocol {
    ...
    public void onObjectUploadFailed(String name, long objectId, long parentId, long atState, long status) {
        System.out.println("ObjectUploadError: name=\"" + name + "\" ("+objectId+")");
        System.out.println("ObjectUploadError: parentId=" + parentId);
        System.out.println("ObjectUploadError: atState="  + atState);
        System.out.println("ObjectUploadError: status="   + status);
        this.finished = true;
    }
